    ...
    <div class="row">
      <div class="large-12 columns">
        <table width="100%">
          ...
          <tbody>
            <?php for($i = 0; $i<count($famous_tech_people); $i++){ ?>
            <tr>
              <td><?php echo $famous_tech_people[$i]['name'] ?></td>
              <td><?php echo $famous_tech_people[$i]['address'] ?></td>
              <td><?php echo $famous_tech_people[$i]['email'] ?></td>
              <td>
              <?php 
              if($famous_tech_people[$i]['availability'])
              {
                echo 'Si';
              } else {
                echo 'No';
